    ...
    return (
        <div className={`bg-white p-3 rounded-lg text-sm flex ${className}`}>
            ...
            <div className='w-1/2 flex flex-wrap justify-end text-right'>
                ...
                <select id={selectId} className='rounded-lg px-1 py-1 bg-gray-100 cursor-pointer outline-none' value={selectCurrency} onChange={(e)=>onCurrencyChange && onCurrencyChange(e.target.value)} disabled={currencyDisable}>
